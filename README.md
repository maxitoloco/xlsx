...
[![CI](https://github.com/maxitoloco/xlsx/actions/workflows/check.yml/badge.svg)](https://github.com/maxitoloco/xlsx/actions/workflows/check.yml) [![codecov](https://codecov.io/gh/maxitoloco/xlsx/graph/badge.svg)](https://codecov.io/gh/maxitoloco/xlsx) [![npm version](https://badge.fury.io/js/xlsx-write-stream.svg)](http://badge.fury.io/js/xlsx-write-stream)
